...
bedtools getfasta -fi GCF_004348235.1_GSC_HSeal_1.0_genomic.fna -bed Test_SalishSea_seals.bed -name -fo SalishSea_seals_flankSNPs.fasta 
...
perl -pe '$. > 1 and /^>/ ? print "\n" : chomp' Test_SalishSea_seals_flankSNPs.fasta > Test_outSNPs.fasta
python3
